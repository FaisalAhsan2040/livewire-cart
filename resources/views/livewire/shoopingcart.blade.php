                ...
                <div class="my-4 mt-6 -mx-2 lg:flex">
                    ...
                    <div class="lg:px-2 lg:w-1/2">
                        ...
                        <div class="p-4">
                            ...
                            <button class="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none" wire:click="checkout" wire:loading.attr="disable">
                            ...
                            <div wire:loading>payment process .....</div>
                        </div>
                    </div>
                </div>
            </div>
